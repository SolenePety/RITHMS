...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "An Advanced Stochastic Framework for the Simultion of Transgenerational Hologenomic Data",
    Description = "RITHMS, an R Implementation of a Transgenerational Hologenomic Model-based
Simulator is an open-source package, builds upon the MoBPS package and incorporates the distinctive architecture of the microbiota, notably vertical and horizontal transfer as well as modulation due to the environment and host genetics",
    `Authors@R` = c(
      person("Solène", "Pety", email = "solene.pety@inrae.fr", role = c("aut", "cre", "cph"), comment = c(ORCID = "0000-0002-1245-7425")),
      person("Ingrid", "David", email = "ingrid.david@inrae.fr", role = c("aut", "ths"), comment = c(ORCID = "0000-0002-2514-6693")),
      person("Mahendra", "Mariadassou", email = "mahendra.mariadassou@inrae.fr", role = c("aut", "ths"), comment = c(ORCID = "0000-0003-2986-354X")),
      person("Andrea", "Rau", email = "andrea.rau@inrae.fr", role = c("aut", "ths"), comment = c(ORCID = "0000-0001-6469-488X"))
    )
  ),
overwrite = T
)
# Define License with use_*_license()
usethis::use_mit_license("Solene Pety")
```
