...
datafile <- system.file("BasePopTest.rds", package = "RITHMS")
...
```{r examples-useful_formatting_data, message=FALSE, warning=FALSE}
...
```{r examples-taxa_assignment, message=FALSE, warning=FALSE}
...
```{r examples-genetic_effect, message=FALSE, warning=FALSE}
datafile <- system.file("DeruPop.rds", package = "RITHMS")
ToyData <- readRDS(datafile)
taxa_assign_g <- assign_taxa(founder_object = ToyData)
...
```{r examples-holo_simu, message=FALSE, warning=FALSE}
datafile <- system.file("DeruPop.rds", package = "RITHMS")
ToyData <- readRDS(datafile)
taxa_assign_g <- assign_taxa(founder_object = ToyData)
generations_simu <- holo_simu(h2 = 0.25,
