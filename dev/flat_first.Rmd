...
#' 
#' This function computes the parameter used to build a beta matrix with a given correlation
#' structure between taxa. It is used in the beta matrix construction.
#' 
