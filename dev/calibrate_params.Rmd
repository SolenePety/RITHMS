...
The genetic effect size parameter $\sigma \beta$ directly impacts the distribution of taxa heritabilities (Further explanations are given in @https://doi.org/10.48550/arxiv.2502.07366 ). The `gen_effect_calibration()` function allows users to evaluate how different values of $\sigma \beta$ influence this distribution.
...
Based on the @Zang2022 expectations, a reasonable distribution of taxa heritabilities appears to correspond to a value of $\sigma \beta * \sqrt {QTL_o} = 0.3$ in the case of @Dru2020 dataset.
