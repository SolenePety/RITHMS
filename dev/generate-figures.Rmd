...
ggsave("../inst/extdata/freeze/Heatmap_correlation.png", p1, width = 9, height = 6)
```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/Heatmap_correlation.png")
```
...
p3
ggsave("../inst/extdata/freeze/lambda_correlation.png", p3, width = 9, height = 6)
```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/lambda_correlation.png")
```
...
density_peaks <- out_data %>%
 ...
 p2
 ggsave("../inst/extdata/freeze/density_taxa_heri.png", p2, width = 9, height = 6)
```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/density_taxa_heri.png")
```
...
p4
ggsave("../inst/extdata/freeze/ridges_shannon.png", p4, width = 9, height = 6)
```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/ridges_shannon.png")
```
...
ggsave("../inst/extdata/freeze/global_microbiome.png", plot_grid(top_row, bottom_row,nrow=2), width = 9, height = 6)
```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/global_microbiome.png")
```
...
diversities_microbiomes <- generations_simu_env[-1] %>% map(get_microbiomes) %>% map(richness_from_abundances_gen) |> bind_rows(.id = "Generation")
  ...
  p1
  ggsave("../inst/extdata/freeze/antibio_shannon.png", p1, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/antibio_shannon.png")
```
...
p2
ggsave("../inst/extdata/freeze/mds_antibio.png", p2, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/mds_antibio.png")
```
...
diversities_microbiomes <- generations_simu_env[c(2,3,4,5)] %>% map(get_microbiomes) %>% map(richness_from_abundances_gen) |> bind_rows(.id = "Generation")
  ...
  p4 <- ggplot(diversities_microbiomes,aes(x=Shannon,y=Generation,fill=Generation)) +
        ...
        scale_fill_manual(values = rev(greens_pal)[1:4])
p4
ggsave("../inst/extdata/freeze/diet_shannon.png", p4, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/diet_shannon.png")
```
...
p3 <- ggplot(data = DF, aes(x=DF[,1], y=DF[,2], color = diet, shape=diet)) + 
  ...
  scale_fill_manual(values = rev(greens_pal)[1:4])
p3
ggsave("../inst/extdata/freeze/mds_diet.png", p3, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/mds_diet.png")
```
...
```{r}
plot_grid(top_row,bottom_row,nrow = 2)
ggsave("../inst/extdata/freeze/global_env.png", plot_grid(top_row, bottom_row,nrow=2), width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/global_env.png")
```
...
p2
ggsave("../inst/extdata/freeze/barplot_h2_b2.png", p2, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/barplot_h2_b2.png")
```
...
p1
ggsave("../inst/extdata/freeze/selection_mode.png", p1, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/selection_mode.png")
```
...
ggsave("../inst/extdata/freeze/global_phenotype.png", plot_grid(p2, p1, labels = c('A', 'B'), rel_widths = c(1,2)), width = 10, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/global_phenotype.png")
```
...
p
ggsave("../inst/extdata/freeze/use_case.png", p, width = 9, height = 6)

```

```{r,eval=TRUE,out.width="80%"}
knitr::include_graphics("../inst/extdata/freeze/use_case.png")
```
